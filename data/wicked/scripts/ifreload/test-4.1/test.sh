...
step0()
{
	...
	log_device_config "$br0" "$eth0" "$eth1"
}
...
step4()
{
	...
	echo "wicked ifreload --dry-run $cfg $br0"
	wicked ifreload --dry-run $cfg $br0
	echo ""
...
step6()
{
	...
	echo "wicked ifreload --dry-run $cfg $eth0"
	wicked ifreload --dry-run $cfg "$eth0"
	echo ""
...
step9()
{
	...
	echo "wicked ifreload --dry-run $cfg $eth1"
	wicked ifreload --dry-run $cfg "$eth1"
	echo ""
