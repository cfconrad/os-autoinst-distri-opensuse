...
sub prepare_packages {
    ...
    my $hostapd_repo = get_var('WICKED_CI_REPO', 'https://download.opensuse.org/repositories/home:/cfconrad:/wicked-ci:/openQA/' . generate_version());
    zypper_ar($hostapd_repo, name => 'wicked-ci-hostapd', priority => 10) if ($hostapd_repo);
